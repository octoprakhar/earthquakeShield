...
function ContactPage() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetch("http://localhost:5000/emergencyContact", {
          method: "POST",
          headers: {
      ...
      <div className="contact-cont">
        <div className="customer-cont">
          ...
          <p className="Contact-desc">
            Have any question? Our team is here to help. Reach out to us using
            this form or contact information.
          </p>
          <form className="contact-form">
            ...
            <div className="emergency-cont">
              ...
              <p className="emergency-message">
                Mark as urgent(for emergency related query only)
              </p>
            </div>
            <button
              type="submit"
        ...
        <div className="our-cont">
          <p className="our-cont-title">Contact Information</p>
          <div className="email-cont">
            ...
            <p className="cont-body">info@earthquake.com</p>
          </div>
          <div className="email-cont">
            <div className="cont-heads">
              <svg
            ...
            <p className="cont-body">+91 1111 222 333</p>
          </div>
          <div className="email-cont">
            <div className="cont-heads">
              <svg
            ...
            <p className="cont-body">Green Park, Gurugram, Haryana, India</p>
          </div>
          <p className="our-cont-title">Operating Hours</p>
          <p className="cont-body">Monday-Friday:  8:00 AM - 6:00 PM</p>
          <p className="cont-body">Saturday:       9:00 AM - 3:00 PM</p>
          <p className="cont-body">Sunday:         Closed</p>
          <hr className="cont-hr-line" />
        </div>
      </div>
    );
  }
